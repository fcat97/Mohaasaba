...
public class TransactionPageAdapter  extends ListAdapter<TransactionPage, TransactionPageAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            labelTextView = itemView.findViewById(R.id.label_TransactionPage_TextView_HisaabActivity);
            recyclerView = itemView.findViewById(R.id.recyclerView_TransactionPage_TextView_HisaabActivity);
            totalTextView = itemView.findViewById(R.id.totalAmount_TransactionPage_TextView_HisaabActivity);
        }
    }
